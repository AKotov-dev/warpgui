...
begin
  ...
  try
    ...
    ChangeProcess.Parameters.Add(
      'warp-cli disconnect; i=0; while [[ $(ip -br a | grep CloudflareWARP) ]]; do warp-cli disconnect; '
      ...
      + 'i=0; while [[ -z $(ip -br a | grep CloudflareWARP) ]]; do warp-cli connect; sleep 1; ((i++)); '
      + 'if [[ $i == 5 ]]; then warp-cli disconnect; break; fi; done');
